...
% TODO: Needs to be rewritten with actual groups
...
A crucial part is the customer request $r$, since that is the data that we will train on and use in the simulation
...
\begin{tabularx}{\textwidth}{@{}c|c|X@{}}
  ...
  \hline
  \multicolumn{3}{@{}l}{Time independent metrics:} \\\hline 
  ...
  \hline
  \multicolumn{3}{@{}l}{Time dependent metrics:} \\
  \hline
\end{tabularx}
